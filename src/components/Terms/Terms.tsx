...
const Terms: FC = () => {
    return (
        <div className="container" style={{ textAlign: "justify" }}>
            ...
            <p>
                1.1. Sklep Internetowy dostępny pod adresem internetowym www.takustudio.pl prowadzony jest przez
                Agnieszkę Powązkę prowadzącą działalność gospodarczą pod nazwą Agnieszka Powązka Taku Studio (adres
                miejsca prowadzenia działalności i adres do doręczeń: ul. Jana Kazimierza 47a m 42, 01-267 Warszawa),
                NIP:1132782431, REGON: 380930463, adres poczty elektronicznej: agnieszka.powazka@gmail.com.
            </p>
            <p>
            ...
            <p>
                ...
                postanowień niniejszego Regulaminu jest Sprzedawca. Dane osobowe przetwarzane są w celach, w zakresie i
                w oparciu o podstawy i zasady wskazane w polityce prywatności opublikowanej na stronie Sklepu
            ...
            <h3>2. USŁUGI ELEKTRONICZNE W SKLEPIE INTERNETOWYM</h3>
            <p>
                2.1. W Sklepie Internetowym dostępne są następujące Usługi Elektroniczne: Formularz Zamówienia –
                korzystanie z Formularza Zamówienia rozpoczyna się z momentem dodania przez Klienta pierwszego Produktu
                do elektronicznego koszyka w Sklepie Internetowym. Złożenie Zamówienia następuje po wykonaniu przez
                Klienta łącznie dwóch kolejnych kroków – (1) po wypełnieniu Formularza Zamówienia i (2) kliknięciu na
                stronie Sklepu Internetowego po wypełnieniu Formularza Zamówienia pola „Zapłać” – do tego momentu
                ...
                nazwisko, kraj, adres poczty elektronicznej, numer telefonu kontaktowego oraz danych dotyczących Umowy
                Sprzedaży: Produkt/y, ilość Produktu/ów, miejsce i sposób dostawy Produktu/ów, sposób płatności. W
                wypadku Klientów niebędących konsumentami niezbędne jest także podanie nazwy firmy oraz numeru NIP.
                Usługa Elektroniczna Formularz Zamówienia świadczona jest nieodpłatnie oraz ma charakter jednorazowy i
                ulega zakończeniu z chwilą złożenia Zamówienia za jego pośrednictwem albo z chwilą wcześniejszego
            ...
            <p>
                ...
                Usługodawca: (1) komputer, laptop lub inne urządzenie multimedialne z dostępem do Internetu; (2) dostęp
                ...
                minimalna rozdzielczość ekranu: 1024×768; (5) włączenie w przeglądarce internetowej możliwości zapisu
                plików Cookies oraz obsługi Javascript. 2.3. Usługobiorca obowiązany jest do korzystania ze Sklepu
                Internetowego w sposób zgodny z prawem i dobrymi obyczajami, mając na uwadze poszanowanie dóbr
                osobistych oraz praw autorskich i własności intelektualnej Usługodawcy oraz osób trzecich. Usługobiorca
                obowiązany jest do wprowadzania danych zgodnych ze stanem faktycznym. Usługobiorcę obowiązuje zakaz
                dostarczania treści o charakterze bezprawnym. 2.4. Tryb postępowania reklamacyjnego: Reklamacje związane
                ze świadczeniem Usług Elektronicznych przez Usługodawcę oraz pozostałe reklamacje związanie z działaniem
                Sklepu Internetowego (z wyłączeniem procedury reklamacji Produktu, która została wskazana w pkt. 6
                Regulaminu) Usługobiorca może składać na przykład: w formie elektronicznej za pośrednictwem poczty
                elektronicznej na adres: agnieszka.powazka@gmail.com; Zaleca się podanie przez Usługobiorcę w opisie
                reklamacji: (1) informacji i okoliczności dotyczących przedmiotu reklamacji, w szczególności rodzaju i
                daty wystąpienia nieprawidłowości; (2) żądania Usługobiorcy; oraz (3) danych kontaktowych składającego
                reklamację – ułatwi to i przyspieszy rozpatrzenie reklamacji przez Usługodawcę. Wymogi podane w zdaniu
                poprzednim mają formę jedynie zalecenia i nie wpływają na skuteczność reklamacji złożonych z pominięciem
                zalecanego opisu reklamacji. Ustosunkowanie się do reklamacji przez Usługodawcę następuje niezwłocznie,
                nie później niż w terminie 14 dni kalendarzowych od dnia jej złożenia.
            </p>
            <h3>3. WARUNKI ZAWIERANIA UMOWY SPRZEDAŻY</h3>
            <p>
                3.1. Zawarcie Umowy Sprzedaży między Klientem a Sprzedawcą następuje po uprzednim złożeniu przez Klienta
                Zamówienia za pomocą Formularza Zamówienia w Sklepie Internetowym zgodnie z pkt. 2.1.2 Regulaminu.
            </p>
            <p>
                ...
                można ustalić wysokości tych opłat – o obowiązku ich uiszczenia, Klient jest informowany na stronach
                Sklepu Internetowego w trakcie składania Zamówienia, w tym także w chwili wyrażenia przez Klienta woli
                związania się Umową Sprzedaży.
            </p>
            <p>
                3.3. Procedura zawarcia Umowy Sprzedaży w Sklepie Internetowym za pomocą Formularza Zamówienia Zawarcie
                Umowy Sprzedaży między Klientem a Sprzedawcą następuje po uprzednim złożeniu przez Klienta Zamówienia w
                Sklepie Internetowym zgodnie z pkt. 2.1.2 Regulaminu. Po złożeniu Zamówienia Sprzedawca niezwłocznie
                potwierdza jego otrzymanie oraz jednocześnie przyjmuje Zamówienie do realizacji. Potwierdzenie
                otrzymania Zamówienia i jego przyjęcie do realizacji następuje poprzez przesłanie przez Sprzedawcę
                Klientowi stosownej wiadomości e-mail na podany w trakcie składania Zamówienia adres poczty
                elektronicznej Klienta, która zawiera co najmniej oświadczenia Sprzedawcy o otrzymaniu Zamówienia i o
                jego przyjęciu do realizacji oraz potwierdzenie zawarcia Umowy Sprzedaży. Z chwilą otrzymania przez
            ...
            <p>
                5.1. Dostawa Produktu do Klienta jest odpłatna, chyba że Umowa Sprzedaży stanowi inaczej. Koszty dostawy
            ...
            <p>
                5.2. Sprzedawca udostępnia Klientowi następujące sposoby dostawy lub odbioru Produktu: Dostawa do
                Paczkomatu InPost.
            </p>
            <p>
                5.3. Termin dostawy Produktu do Klienta wynosi do 12 Dni Roboczych, chyba że w opisie danego Produktu
                lub w trakcie składania Zamówienia podano krótszy termin. W przypadku Produktów o różnych terminach
                dostawy, terminem dostawy jest najdłuższy podany termin, który jednak nie może przekroczyć 12 Dni
                Roboczych. Początek biegu terminu dostawy Produktu do Klienta liczy się w następujący sposób: W
                przypadku wyboru przez Klienta sposobu płatności elektronicznych lub kartą płatniczą – od dnia uznania
                rachunku bankowego lub rachunku rozliczeniowego Sprzedawcy.
            </p>
            <h3>6. REKLAMACJA PRODUKTU</h3>
            <p>
                ...
                w Kodeksie Cywilnym (w szczególności w art. 556-576 Kodeksu Cywilnego). Dla Umów Sprzedaży zawartych do
                dnia 24 grudnia 2014 roku podstawa i zakres odpowiedzialności Sprzedawcy wobec Klienta będącego osobą
                fizyczną, który nabywa Produkt w celu niezwiązanym z działalnością zawodową lub gospodarczą, z tytułu
                niezgodności Produktu z Umową Sprzedaży są określone powszechnie obowiązującymi przepisami prawa, w
            ...
            <p>
                ...
                Sklepu Internetowego w zakładce informacyjnej dotyczącej reklamacji.
            </p>
            <p>
                6.3. Reklamacja może zostać złożona przez Klienta na przykład: w formie elektronicznej za pośrednictwem
                poczty elektronicznej na adres: agnieszka.powazka@gmail.com;
            </p>
            <p>
                {" "}
                ...
                doprowadzenia Produktu do zgodności z Umową Sprzedaży lub oświadczenia o obniżeniu ceny albo odstąpienia
                od Umowy Sprzedaży; oraz (3) danych kontaktowych składającego reklamację – ułatwi to i przyspieszy
                rozpatrzenie reklamacji przez Sprzedawcę. Wymogi podane w zdaniu poprzednim mają formę jedynie zalecenia
            ...
            <p>
                ...
                obniżona, a Sprzedawca nie ustosunkował się do tego żądania w terminie 14 dni kalendarzowych, uważa się,
                że żądanie to uznał za uzasadnione. 6.6. Klient, który wykonuje uprawnienia z tytułu rękojmi, jest
                obowiązany dostarczyć Produkt wadliwy na adres: ul. Jana Kazimierza 47a m 42, 01-267 Warszawa. W
                przypadku Klienta będącego konsumentem koszt dostarczenia Produktu ponosi Sprzedawca, w przypadku
                Klienta niebędącego konsumentem koszt dostarczenia ponosi Klient. Jeżeli ze względu na rodzaj Produktu
                lub sposób jego zamontowania dostarczenie Produktu przez Klienta byłoby nadmiernie utrudnione, Klient
            ...
            <p>
                ...
                55 60 333, email: kontakt.adr@uokik.gov.pl lub adres pisemny: Pl. Powstańców Warszawy 1, 00-950
                Warszawa), którego zadaniem jest między innymi udzielanie pomocy konsumentom w sprawach dotyczących
            ...
            <p>
                ...
                wniosek w sprawie pozasądowego rozwiązania sporu do wojewódzkiego inspektora Inspekcji Handlowej (więcej
            ...
            <p>
                ...
                umownych wynikających z internetowej umowy sprzedaży lub umowy o świadczenie usług (więcej informacji na
            ...
            <h3>8. PRAWO ODSTĄPIENIA OD UMOWY</h3>
            <p>
                8.1. Konsument, który zawarł umowę na odległość, może w terminie 14 dni kalendarzowych odstąpić od niej
                bez podawania przyczyny i bez ponoszenia kosztów, z wyjątkiem kosztów określonych w pkt. 8.8 Regulaminu.
                Do zachowania terminu wystarczy wysłanie oświadczenia przed jego upływem. Oświadczenie o odstąpieniu od
                umowy może zostać złożone na przykład: w formie elektronicznej za pośrednictwem poczty elektronicznej na
                adres: agnieszka.powazka@gmail.com;
            </p>
            <p>
            ...
            <p>
                {" "}
                8.3. Bieg terminu do odstąpienia od umowy rozpoczyna się: dla umowy, w wykonaniu której Sprzedawca
                wydaje Produkt, będąc zobowiązany do przeniesienia jego własności (np. Umowa Sprzedaży) – od objęcia
                Produktu w posiadanie przez konsumenta lub wskazaną przez niego osobę trzecią inną niż przewoźnik, a w
                przypadku umowy, która: (1) obejmuje wiele Produktów, które są dostarczane osobno, partiami lub w
                częściach – od objęcia w posiadanie ostatniego Produktu, partii lub części albo (2) polega na regularnym
                dostarczaniu Produktów przez czas oznaczony – od objęcia w posiadanie pierwszego z Produktów; dla
            ...
            <p>
                ...
                otrzymania oświadczenia konsumenta o odstąpieniu od umowy, zwrócić konsumentowi wszystkie dokonane przez
                niego płatności, w tym koszty dostawy Produktu (z wyjątkiem dodatkowych kosztów wynikających z wybranego
                przez konsumenta sposobu dostawy innego niż najtańszy zwykły sposób dostawy dostępny w Sklepie
                Internetowym). Sprzedawca dokonuje zwrotu płatności przy użyciu takiego samego sposobu płatności,
                jakiego użył konsument, chyba że konsument wyraźnie zgodził się na inny sposób zwrotu, który nie wiąże
                się dla niego z żadnymi kosztami. Jeżeli Sprzedawca nie zaproponował, że sam odbierze Produkt od
            ...
            <p>
                ...
                Sprzedawcę do odbioru, chyba że Sprzedawca zaproponował, że sam odbierze Produkt. Do zachowania terminu
                wystarczy odesłanie Produktu przed jego upływem. Konsument może zwrócić Produkt na adres: ul. Jana
                Kazimierza 47a m 42, 01-267 Warszawa.
            </p>
            <p>
            ...
            <p>
                ...
                konsument: Jeżeli konsument wybrał sposób dostawy Produktu inny niż najtańszy zwykły sposób dostawy
                dostępny w Sklepie Internetowym, Sprzedawca nie jest zobowiązany do zwrotu konsumentowi poniesionych
                przez niego dodatkowych kosztów. Konsument ponosi bezpośrednie koszty zwrotu Produktu. W przypadku
                Produktu będącego usługą, której wykonywanie – na wyraźne żądanie konsumenta – rozpoczęło się przed
                ...
                umowy. Kwotę zapłaty oblicza się proporcjonalnie do zakresu spełnionego świadczenia, z uwzględnieniem
            ...
            <p>
                ...
                umów: (1) o świadczenie usług, jeżeli Sprzedawca wykonał w pełni usługę za wyraźną zgodą konsumenta,
                który został poinformowany przed rozpoczęciem świadczenia, że po spełnieniu świadczenia przez Sprzedawcę
                utraci prawo odstąpienia od umowy; (2) w której cena lub wynagrodzenie zależy od wahań na rynku
                finansowym, nad którymi Sprzedawca nie sprawuje kontroli, i które mogą wystąpić przed upływem terminu do
                odstąpienia od umowy; (3) w której przedmiotem świadczenia jest Produkt nieprefabrykowany, wyprodukowany
                według specyfikacji konsumenta lub służący zaspokojeniu jego zindywidualizowanych potrzeb; (4) w której
                przedmiotem świadczenia jest Produkt ulegający szybkiemu zepsuciu lub mający krótki termin przydatności
                do użycia; (5) w której przedmiotem świadczenia jest Produkt dostarczany w zapieczętowanym opakowaniu,
                którego po otwarciu opakowania nie można zwrócić ze względu na ochronę zdrowia lub ze względów
                higienicznych, jeżeli opakowanie zostało otwarte po dostarczeniu; (6) w której przedmiotem świadczenia
                są Produkty, które po dostarczeniu, ze względu na swój charakter, zostają nierozłącznie połączone z
                innymi rzeczami; (7) w której przedmiotem świadczenia są napoje alkoholowe, których cena została
                uzgodniona przy zawarciu Umowy Sprzedaży, a których dostarczenie może nastąpić dopiero po upływie 30 dni
                i których wartość zależy od wahań na rynku, nad którymi Sprzedawca nie ma kontroli; (8) w której
                konsument wyraźnie żądał, aby Sprzedawca do niego przyjechał w celu dokonania pilnej naprawy lub
                konserwacji; jeżeli Sprzedawca świadczy dodatkowo inne usługi niż te, których wykonania konsument żądał,
                lub dostarcza Produkty inne niż części zamienne niezbędne do wykonania naprawy lub konserwacji, prawo
                odstąpienia od umowy przysługuje konsumentowi w odniesieniu do dodatkowych usług lub Produktów; (9) w
                której przedmiotem świadczenia są nagrania dźwiękowe lub wizualne albo programy komputerowe dostarczane
                w zapieczętowanym opakowaniu, jeżeli opakowanie zostało otwarte po dostarczeniu; (10) o dostarczanie
                dzienników, periodyków lub czasopism, z wyjątkiem umowy o prenumeratę; (11) zawartej w drodze aukcji
            ...
            <h3>9. POSTANOWIENIA DOTYCZĄCE PRZEDSIĘBIORCÓW</h3>
            <p>
            ...
            <p>
                9.7. W wypadku Usługobiorców nie będących konsumentami Usługodawca może wypowiedzieć umowę o świadczenie
            ...
            <p>
                10.2. Zmiana Regulaminu: Usługodawca zastrzega sobie prawo do dokonywania zmian Regulaminu z ważnych
                przyczyn to jest: zmiany przepisów prawa; zmiany sposobów płatności i dostaw – w zakresie, w jakim te
                zmiany wpływają na realizację postanowień niniejszego Regulaminu. W przypadku zawarcia na podstawie
                niniejszego Regulaminu umów o charakterze ciągłym (np. świadczenie Usługi Elektronicznej – Konto)
                zmieniony regulamin wiąże Usługobiorcę, jeżeli zostały zachowane wymagania określone w art. 384 oraz
                384[1] Kodeksu cywilnego, to jest Usługobiorca został prawidłowo powiadomiony o zmianach i nie
                ...
                będący konsumentem ma prawo odstąpienia od umowy. W przypadku zawarcia na podstawie niniejszego
                Regulaminu umów o innym charakterze niż umowy ciągłe (np. Umowa Sprzedaży) zmiany Regulaminu nie będą w
                żaden sposób naruszać praw nabytych Usługobiorców/Klientów będących konsumentami przed dniem wejścia w
                życie zmian Regulaminu, w szczególności zmiany Regulaminu nie będą miały wpływu na już składane lub
            ...
            <p>
                ...
                niektórych praw konsumentów oraz o odpowiedzialności za szkodę wyrządzoną przez produkt niebezpieczny z
                dnia 2 marca 2000 r. (Dz.U. 2000 nr 22, poz. 271 ze zm.) oraz ustawy o szczególnych warunkach sprzedaży
                konsumenckiej oraz o zmianie Kodeksu cywilnego z dnia 27 lipca 2002 r. (Dz.U. 2002 nr 141, poz. 1176 ze
                zm.); dla Umów Sprzedaży zawartych od 25 grudnia 2014 roku z Klientami będącymi konsumentami – przepisy
                ustawy o prawach konsumenta z dnia 30 maja 2014 r. (Dz.U. 2014 r. poz. 827 ze zm.); oraz inne właściwe
                przepisy powszechnie obowiązującego prawa.
            </p>
            <h3>11. WZÓR FORMULARZA ODSTĄPIENIA OD UMOWY</h3>
            <p>
                11.1. Wzór formularza odstąpienia od umowy (formularz ten należy wypełnić i odesłać tylko w przypadku
                chęci odstąpienia od umowy):
            </p>
            <ul>
                <li>
                    Adresat: Agnieszka Powązka Taku Studio, ul. Jana Kazimierza 47a m 42, 01-267 Warszawa takustudio.pl
                    agnieszka.powazka@gmail.com
                </li>
                <li>
